...
public class RenderSpectrogramDemo {
	public static void main(String[] args) {
		...
		render.renderSpectrogramData(spectrogram.getAbsoluteSpectrogramData(), "spectrogram.jpg");

		// change the spectrogram representation
		int fftSampleSize = 512;
		int overlapFactor = 2;
		spectrogram = new Spectrogram(wave, fftSampleSize, overlapFactor);
		render.renderSpectrogramData(spectrogram.getAbsoluteSpectrogramData() , "spectrogram2.jpg");
	}
}